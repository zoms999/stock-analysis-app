...
async function checkPostAccuracy() {
  const postId = '09fee01f-2d21-4d1f-999a-97d77efd303a';
  
  console.log('=== Checking New Post Accuracy ===\n');
  ...
  // 5. Check if the SQL function would pick this up

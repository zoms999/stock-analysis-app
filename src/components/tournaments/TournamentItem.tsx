...
export default function TournamentItem({ tournament }: TournamentItemProps) {
  ...
  return (
    <Link href={`/tournaments/${tournament.id}`}>
      <div className="group relative overflow-hidden rounded-2xl bg-[#111315] border border-gray-800 hover:border-blue-500/50 transition-all duration-300 hover:shadow-2xl hover:shadow-blue-900/10 hover:-translate-y-1">
        ...
        <div className="p-6">
          <div className="flex justify-between items-start mb-4">
            <div className="flex gap-2">
              ...
              <span className="px-2.5 py-1 rounded-md text-[10px] font-bold border bg-gray-800 text-gray-400 border-gray-700">
                {typeLabel}
              </span>
            </div>
